const { z } = require("zod");
const { pageSectionsSchema, sectionLayoutRecordSchema, sectionSettingsRecordSchema } = require("./visualCmsValidation");
...
const pageContentSchema = z.object({
  body: z.object({
    ...
    sections: pageSectionsSchema.optional().default([]),
